...
| Run storage | `server/storage.py`, `server/stores/*` | `coder-store` | Expand metadata/events/artifacts/blobs/repo-evidence/checkpoints | Stored run and repo-evidence APIs read Rust-created records |
